 ...
 * Spielprotokolls, das auf dem Server laeuft, z.B. Kniffel. Hier werden die
 * Spielerliste (in Form von ServerThreads) und weitere spielrelevante Daten
...
public class Game {
  ...
  /**
   * Diese Methode unterbricht die Verbindung (im Fehlerfall) zu allen Spielern
   ...
   * Diese Methode wird vom ServerThread des ersten Spielers aufgerufen, nachdem
   * dieser den "Spiel starten"-Button betaetigt hat (siehe auch Diagramm
   * "Spiel starten").
   */
  public void start() {
