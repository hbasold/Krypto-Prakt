...
/**
 * Die Klasse ClientGUI stellt die grafische Oberflaeche des Clients dar. Hier
 * werden die Funktionen des Clients fuer den Anwender zugreifbar. Servername,
 * Spielname und Portnummer werden in der grafischen Oberflaeche eingegeben und
 * der Benutzer wird durch Druecken des Buttons "mit Server verbinden" mit dem
 * Server verbunden. Wenn er als erster Spieler am Server angemeldet ist, hat er
...
public class ClientGUI extends Frame implements Runnable {
  ...
  private void jbInit() throws Exception {
    ...
    header
        .setText("Bitte Server- und Spielname  eingeben und mit Server verbinden.");
    ...
    this.add(clientExit, new GridBagConstraints(1, 6, 2, 1, 0.0, 0.0,
        GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(30, 0,
            0, 0), 0, 10));
    this.add(output, new GridBagConstraints(0, 7, 3, 1, 1.0, 0.0,
        GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(5, 5, 0,
            5), 1, 0));
